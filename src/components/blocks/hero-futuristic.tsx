...
export const Html = () => {
  ...
  return (
    <div className="hero-shell">
      <div className="hero-overlay h-svh uppercase items-center w-full pointer-events-none px-10 flex justify-center flex-col">
        <div className="text-3xl md:text-5xl xl:text-6xl 2xl:text-7xl font-extrabold">
          <div className="hero-title flex space-x-2 lg:space-x-6 overflow-hidden text-white">
        ...
        <div className="text-xs md:text-xl xl:text-2xl 2xl:text-3xl mt-2 overflow-hidden text-white font-bold">
          <div
            className={`hero-subtitle ${subtitleVisible ? 'fade-in-subtitle' : ''}`}
